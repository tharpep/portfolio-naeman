    ...
    return (
        <main className="text-ink min-h-screen px-6 sm:px-8 md:px-16 lg:px-24 py-12">
            <div className="max-w-4xl mx-auto">
                {/* Header */}
                <h1 className="text-4xl font-bold font-mono text-ink mb-2">
                    Naeman Khatib
                </h1>
                <p className="text-ink-mid mb-8">
                    nkhatib1022@gmail.com ·{" "}
                    <a href="https://linkedin.com/in/naeman-khatib" className="text-teal hover:text-teal-dark transition-colors">
                        linkedin.com/in/naeman-khatib
                    </a>
                </p>

                <div className="w-full h-px bg-warm-line mb-10" />

                {/* Education */}
                <section className="mb-10">
                    <h2 className="text-xl font-bold font-mono text-teal mb-4 pb-2 border-b border-teal/30">
                        Education
                    </h2>
                    <div>
                        <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                            <h3 className="font-bold text-ink">Purdue University</h3>
                            <span className="text-ink-faint font-mono text-sm">Jul 2022 – May 2026</span>
                        </div>
                        <p className="text-ink-mid italic mb-2">
                ...
                <section className="mb-10">
                    ...
                    <div>
                        <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                            <h3 className="font-bold text-ink">Transport: Modeling, Numerics and Theory Laboratory</h3>
                            <span className="text-ink-faint font-mono text-sm">Aug 2025 – Present</span>
                        </div>
                        <p className="text-ink-mid italic mb-2">Undergraduate Researcher</p>
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Remote Controlled Flying Bison — Purdue ME 444</h3>
                                <span className="text-ink-faint font-mono text-sm">Jan – May 2024</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Drip Defender Prototype — Purdue ME Sophomore Design</h3>
                                <span className="text-ink-faint font-mono text-sm">Aug – Dec 2023</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">GEARS Autonomous Rover — Purdue Honors Engineering</h3>
                                <span className="text-ink-faint font-mono text-sm">Jan – May 2023</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Purdue ASME Grand Prix Team</h3>
                                <span className="text-ink-faint font-mono text-sm">Aug – Dec 2024</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">AI in Work and Society — Global Leadership Program, Hiroshima</h3>
                                <span className="text-ink-faint font-mono text-sm">Aug 2024</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Purdue Space Program — Satellites Subteam</h3>
                                <span className="text-ink-faint font-mono text-sm">Jan – May 2023</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                ...
                <section className="mb-10">
                    ...
                    <div className="space-y-6">
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Purdue Rack and Roll</h3>
                                <span className="text-ink-faint font-mono text-sm">Jan 2025 – Present</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between mb-2">
                                <h3 className="font-bold text-ink">Purdue Minority Engineering Program</h3>
                                <span className="text-ink-faint font-mono text-sm">Jun – Aug 2023/2024</span>
                            </div>
                            <ul className="list-disc list-inside text-ink-mid space-y-1 ml-2">
                ...
                <section className="mb-10">
                    ...
                    <div className="p-4 rounded-xl border border-warm-line bg-cream-card">
                ...
                <div className="text-center pt-4">
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-teal hover:bg-teal-dark text-cream font-semibold rounded-lg transition-colors"
                    >
